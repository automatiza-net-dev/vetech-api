...
export default class BillsController {
  ...
  public async aggregateClientPayments({
    params,
    auth,
    response,
  }: HttpContextContract) {
  ...
  public async recalculate({ params, auth, response }: HttpContextContract) {
    await this.service.recalculateItemsTaxes(
      await this.sharedService.getAuthContext(auth),
      params.id,
    );
  ...
  public async updateBillSeller({
    ...
    await this.service.updateBillSeller(authCtx, payload);
  ...
  public async getClientPaymentSales({
    params,
    auth,
    response,
  }: HttpContextContract) {
