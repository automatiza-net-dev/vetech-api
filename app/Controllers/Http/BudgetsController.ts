...
export default class BudgetsController {
  ...
  public async openNegotiations({ params, response, auth }: HttpContextContract) {
  ...
  public async updateBudget({ request, response, auth }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
      ...
      await this.service.updateBudget(await this.sharedService.getAuthContext(auth), payload);

      return response.noContent();
    });
  }

  public async updateBudgetObservation({ request, response, params, auth }: HttpContextContract) {
  ...
  public async createBudgetItem({ request, response, auth }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
  ...
  public async createBudgetItems({ request, response, auth }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
  ...
  public async updateBudgetItems({ request, response, auth }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
  ...
  public async deleteBudgetItem({ params, response, auth }: HttpContextContract) {
    await this.service.deleteBudgetItem(await this.sharedService.getAuthContext(auth), params.id);

    return response.noContent();
  }

  public async confirmBudget({ params, request, response, auth }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
  ...
  public async cancelBudget({ params, request, response, auth }: HttpContextContract) {
  ...
  public async deleteBudget({ params, response, auth }: HttpContextContract) {
    await this.service.deleteBudget(await this.sharedService.getAuthContext(auth), params.id);

    return response.noContent();
  }

  public async addKitToBudget({ request, response, auth }: HttpContextContract) {
  ...
  public async createBudgetPayments({ request, response, auth }: HttpContextContract) {
    const payload = await request.validate(CreateBudgetPaymentValidator);

    await this.service.createBudgetPayments(await this.sharedService.getAuthContext(auth), payload);

    return response.created();
  }

  public async updateBudgetPayment({ request, response, auth }: HttpContextContract) {
    const payload = await request.validate(UpdateBudgetPaymentValidator);

    await this.service.updateBudgetPayment(await this.sharedService.getAuthContext(auth), payload);

    return response.noContent();
  }

  public async excludeBudgetPayment({ request, response, auth }: HttpContextContract) {
    const payload = await request.validate(ExcludeBudgetPaymentValidator);

    await this.service.excludeBudgetPayment(await this.sharedService.getAuthContext(auth), payload);

    return response.noContent();
  }

  public async listBudgetPayments({ request, response, auth }: HttpContextContract) {
  ...
  public async approveBudgetCourtesyMaxDiscounts({ request, response, auth }: HttpContextContract) {
    const authCtx = await this.sharedService.getAuthContext(auth);
    const payload = await request.validate(ApproveBudgetCourtesyMaxDiscountValidator);
  ...
  public async deleteBudgetItemDepartments({ request, response, auth }: HttpContextContract) {
    const authCtx = await this.sharedService.getAuthContext(auth);
