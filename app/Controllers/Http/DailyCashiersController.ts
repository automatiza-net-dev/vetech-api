...
export default class DailyCashiersController {
  ...
  public async checkCashierStatus({ auth, response }: HttpContextContract) {
    const dailyMovement = await this.service.checkCashierStatus(
  ...
  public async openDailyCashier({ auth, request, response }: HttpContextContract) {
  ...
  public async closeDailyCashier({ auth, request, response, params }: HttpContextContract) {
  ...
  public async reopenDailyCashier({ auth, response, params }: HttpContextContract) {
  ...
  public async checkDailyCashier({ auth, request, response, params }: HttpContextContract) {
    const authCtx = await this.sharedService.getAuthContext(auth);
    const data = await request.validate(CheckDailyCashierValidator);
    const dailyMovement = await this.service.checkDailyCashier(authCtx, params.id, data);

    return response.ok(dailyMovement);
  }

  public async reviewDailyCashier({ auth, request, response, params }: HttpContextContract) {
  ...
  public async createCashierExpense({ auth, request, response, params }: HttpContextContract) {
  ...
  public async createCashierReceipt({ auth, request, response, params }: HttpContextContract) {
  ...
  public async updateConference({ auth, request, response }: HttpContextContract) {
