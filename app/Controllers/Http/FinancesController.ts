...
export default class FinancesController {
  ...
  async groupedIndex({ auth, request, response }: HttpContextContract) {
    const qs = request.qs();
    const result = await this.service.groupedIndex(await this.sharedService.getAuthContext(auth), {
      fromIssueDate: qs.fromIssue,
      toIssueDate: qs.toIssue,
  ...
  async storeBordero({ auth, request, response }: HttpContextContract) {
    ...
    await this.service.createBordero(await this.sharedService.getAuthContext(auth), payload);
  ...
  async storeBorderoItems({ auth, request, response }: HttpContextContract) {
    ...
    await this.service.createBorderoItem(await this.sharedService.getAuthContext(auth), payload);
  ...
  async closeBordero({ auth, request, response }: HttpContextContract) {
    ...
    await this.service.closeBordero(await this.sharedService.getAuthContext(auth), payload);
  ...
  async reopenBordero({ auth, request, response }: HttpContextContract) {
    ...
    await this.service.reopenBordero(await this.sharedService.getAuthContext(auth), payload);
  ...
  async updateBordero({ auth, request, response }: HttpContextContract) {
    ...
    await this.service.updateBordero(await this.sharedService.getAuthContext(auth), payload);
  ...
  async excludeBordero({ auth, request, response }: HttpContextContract) {
    ...
    await this.service.excludeBordero(await this.sharedService.getAuthContext(auth), payload);
  ...
  async excludeBorderoItems({ auth, request, response }: HttpContextContract) {
    ...
    await this.service.excludeBorderoItems(await this.sharedService.getAuthContext(auth), payload);
  ...
  async storeMultipleFinances({ auth, request, response }: HttpContextContract) {
  ...
  async updateFinance({ params, auth, request, response }: HttpContextContract) {
  ...
  async groupedFinanceDown({ auth, request, response }: HttpContextContract) {
    ...
    await this.service.groupedFinanceDown(await this.sharedService.getAuthContext(auth), payload);
  ...
  async updateFinanceDown({ auth, request, response }: HttpContextContract) {
    ...
    await this.service.updateFinanceDown(await this.sharedService.getAuthContext(auth), payload);
  ...
  async updateBorderoDown({ auth, request, response }: HttpContextContract) {
    ...
    await this.service.downBordero(await this.sharedService.getAuthContext(auth), payload);

    return response.noContent();
  }

  async updateRevertBorderoDown({ auth, request, response }: HttpContextContract) {
    const payload = await request.validate(RevertDownBorderoValidator);

    await this.service.revertDownBordero(await this.sharedService.getAuthContext(auth), payload);

    return response.noContent();
  }

  async updateFinanceReversal({ params, auth, request, response }: HttpContextContract) {
    const { unit_id } = this.sharedService.extractUser(auth);
    const payload = await request.validate(UpdateFinanceReversalValidator);

    const result = await this.service.updateFinanceReversal(unit_id, params.id, payload);

    return response.ok(result);
  }

  async deleteFinance({ params, auth, response }: HttpContextContract) {
    await this.service.deleteFinance(await this.sharedService.getAuthContext(auth), params.id);
  ...
  async deleteManyFinances({ request, auth, response }) {
    ...
    await this.service.deleteMultipleFinances(await this.sharedService.getAuthContext(auth), data);
  ...
  async acceptManyFinances({ auth, request, response }: HttpContextContract) {
    ...
    await this.service.acceptMany(await this.sharedService.getAuthContext(auth), payload);

    return response.noContent();
  }

  async notAcceptManyFinances({ auth, request, response }: HttpContextContract) {
    const payload = await request.validate(NotAcceptManyFinanceValidator);

    await this.service.notAcceptMany(await this.sharedService.getAuthContext(auth), payload);
