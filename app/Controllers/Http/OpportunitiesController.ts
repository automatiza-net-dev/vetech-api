...
export default class OpportunitiesController {
  ...
  public async searchActivities({ request, response, auth }: HttpContextContract) {
  ...
  public async searchCompleteKanban({ request, response, auth }: HttpContextContract) {
  ...
  public async searchKanbanActivities({ request, response, auth }: HttpContextContract) {
  ...
  public async storeFromSchedule({ request, response, auth }: HttpContextContract) {
    const payload = await request.validate(CreateOpportunityFromScheduleValidator);
    const authCtx = await this.sharedService.getAuthContext(auth);
  ...
  public async updateClient({ request, response, auth, params }: HttpContextContract) {
  ...
  public async closeWinning({ request, response, auth, params }: HttpContextContract) {
  ...
  public async closeLoosing({ request, response, auth, params }: HttpContextContract) {
  ...
  public async updateStatus({ request, response, auth, params }: HttpContextContract) {
  ...
  public async updateUser({ request, response, auth, params }: HttpContextContract) {
  ...
  public async createActivity({ request, response, auth }: HttpContextContract) {
  ...
  public async executeActivity({ request, response, auth, params }: HttpContextContract) {
  ...
  public async updateActivity({ request, response, auth }: HttpContextContract) {
  ...
  public async cancelActivity({ request, response, auth, params }: HttpContextContract) {
    const payload = await request.validate(CancelOpportunityActivityValidator);
    const authCtx = await this.sharedService.getAuthContext(auth);
  ...
  public async excludeActivity({ response, auth, params }: HttpContextContract) {
    const authCtx = await this.sharedService.getAuthContext(auth);
  ...
  public async searchSyncableOpportunities({ response, auth, request }: HttpContextContract) {
    const authCtx = await this.sharedService.getAuthContext(auth);

    const result = await this.service.searchSyncableOpportunities(authCtx, request.qs());
    return response.ok(result);
  }

  public async searchSyncableSchedules({ response, auth, request }: HttpContextContract) {
    const authCtx = await this.sharedService.getAuthContext(auth);

    const result = await this.service.searchSyncableSchedules(authCtx, request.qs());
    return response.ok(result);
  }
  ...
  public async excludeOpportunity({ response, auth, params }: HttpContextContract) {
    const authCtx = await this.sharedService.getAuthContext(auth);
  ...
  public async updateOpportunityPatient({ response, auth, request }: HttpContextContract) {
