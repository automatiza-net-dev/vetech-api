...
export default class PatientsController {
  ...
  public async nonPets({ auth, response }: HttpContextContract) {
    const result = await this.service.nonPets(await this.sharedService.getAuthContext(auth));

    return response.ok(result);
  }

  public async uniqueOrigins({ auth, response }: HttpContextContract) {
    const result = await this.service.uniqueOrigins(await this.sharedService.getAuthContext(auth));
  ...
  public async display({ auth, params, request, response }: HttpContextContract) {
  ...
  public async search({ auth, request, response }: HttpContextContract) {
    ...
    const patients = await this.service.search(await this.sharedService.getAuthContext(auth), data);
  ...
  public async declareDeath({ auth, params, request, response }: HttpContextContract) {
  ...
  public async unlinkHolderDependent({ auth, request, response }: HttpContextContract) {
  ...
  public async massRemoveRecords({ auth, request, response }: HttpContextContract) {
    const payload = await request.validate(MassRemovePatientValidator);

    await this.service.massRemoveRecords(await this.sharedService.getAuthContext(auth), payload);
