...
export default class PaymentMethodsController {
  ...
  public async searchPartialPaymentMethods({ auth, request, response }: HttpContextContract) {
  ...
  public async searchCompletePaymentMethods({ auth, request, response }: HttpContextContract) {
    const { unit_id } = this.sharedService.extractUser(auth);
  ...
  public async searchTefFlags({ auth, request, response }: HttpContextContract) {
    const { unit_id } = this.sharedService.extractUser(auth);
  ...
  public async createPaymentMethod({ auth, request, response }: HttpContextContract) {
  ...
  public async updatePaymentMethod({ auth, request, response, params }: HttpContextContract) {
  ...
  public async createPaymentMethodFlag({ auth, request, response }: HttpContextContract) {
    const { unit_id } = this.sharedService.extractUser(auth);
  ...
  public async updatePaymentMethodFlag({ auth, params, request, response }: HttpContextContract) {
    const { unit_id } = this.sharedService.extractUser(auth);
  ...
  public async createPaymentMethodFee({ auth, request, response }: HttpContextContract) {
    const { unit_id } = this.sharedService.extractUser(auth);
  ...
  public async updatePaymentMethodFlagInstallment({
    ...
    const { unit_id } = this.sharedService.extractUser(auth);
    const payload = await request.validate(UpdatePaymentMethodFlagInstallmentValidator);
  ...
  public async listBusinessUnitCheckingAccountPaymentMethod({
    ...
    const result = await this.service.listBusinessUnitCheckingAccountPaymentMethod(
      await this.sharedService.getAuthContext(auth),
      request.qs(),
    );
  ...
  public async createBusinessUnitCheckingAccountPaymentMethod({
    ...
    const payload = await request.validate(CreateDefaultCheckingAccountValidator);
    const result = await this.service.createBusinessUnitCheckAccountPaymentMethod(
      await this.sharedService.getAuthContext(auth),
      payload,
    );
  ...
  public async updateBusinessUnitCheckingAccountPaymentMethod({
    ...
    const payload = await request.validate(UpdateDefaultCheckingAccountValidator);
    const result = await this.service.updateBusinessUnitCheckAccountPaymentMethod(
      await this.sharedService.getAuthContext(auth),
      payload.items,
    );
