...
export default class SchedulesController {
  ...
  public async searchScheduleEvents({ auth, request, response }: HttpContextContract) {
  ...
  public async searchSchedulesToAddToMovement({ auth, request, response }: HttpContextContract) {
  ...
  public async schedulesAttendances({ auth, request, response }: HttpContextContract) {
  ...
  public async returnableSchedules({ auth, response, params }: HttpContextContract) {
  ...
  public async reschedule({ auth, params, request, response }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
  ...
  public async reopenSchedule({ auth, params, request, response }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
  ...
  public async upsertStatus({ auth, params, request, response }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
  ...
  public async updateStatus({ auth, request, response }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
      const payload = await request.validate(UpdateScheduleSpecificStatusValidator);
      const authCtx = await this.sharedService.getAuthContext(auth);

      const result = await this.service.updateScheduleStatusWithStaticValues(authCtx, payload);

      return response.ok(result);
    });
  }

  public async updateStatusType({ auth, request, response }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
      const payload = await request.validate(UpdateScheduleStatusTypeValidator);
      const authCtx = await this.sharedService.getAuthContext(auth);

      const result = await this.service.updateScheduleStatusFromType(authCtx, payload);
  ...
  public async destroy({ auth, request, response }: HttpContextContract) {
    ...
    await this.service.destroy(await this.sharedService.getAuthContext(auth), payload);

    return response.noContent();
  }

  public async viewDisponibility({ auth, request, response }: HttpContextContract) {
    const { unit_id } = this.sharedService.extractUser(auth);
  ...
  public async viewServiceGroups({ auth, request, response }: HttpContextContract) {
    const { unit_id } = this.sharedService.extractUser(auth);
    const qs = request.qs();
  ...
  public async userDailySchedule({ auth, request, response }: HttpContextContract) {
  ...
  public async simpleUserDailySchedule({ auth, request, response }: HttpContextContract) {
  ...
  public async usersWeeklySchedule({ auth, request, response }: HttpContextContract) {
  ...
  public async userAppointments({ auth, params, request, response }: HttpContextContract) {
    const { unit_id } = this.sharedService.extractUser(auth);
  ...
  public async getScheduleStatusChanges({ auth, params, response }: HttpContextContract) {
    const authCtx = await this.sharedService.getAuthContext(auth);

    const result = await this.service.getScheduleStatusChanges(authCtx, params.id);
  ...
  public async getPatientSchedules({ auth, params, response }: HttpContextContract) {
    const authCtx = await this.sharedService.getAuthContext(auth);

    const result = await this.service.getPatientSchedules(authCtx, params.patient);
  ...
  public async finances({ auth, request, response }: HttpContextContract) {
    ...
    const result = await this.service.finances(authCtx, request.param("clientID"));

    return response.ok(result);
  }

  public async publicConfirmationInfo({ request, response }: HttpContextContract) {
    const result = await this.service.publicConfirmationInfo(request.param("scheduleID"));

    return response.ok(result);
  }

  public async publicConfirmationUpdate({ request, response }: HttpContextContract) {
