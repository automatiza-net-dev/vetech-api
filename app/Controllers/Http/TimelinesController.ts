...
export default class TimelinesController {
  ...
  public async patientEvaluationIndex({ params, response }: HttpContextContract) {
    return response.ok(await this.timelineService.evaluationIndex(params.id));
  }

  public async storePatientEvaluation({ request, response, auth }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
  ...
  public async updatePatientEvaluation({ params, request, response }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
      const payload = await request.validate(CreatePatientEvaluationValidator);
      const result = await this.timelineService.updateEvaluation(params.id, payload);
      return response.ok(result);
    });
  }

  public async deletePatientEvaluationPhoto({ params, response }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
  ...
  public async storePatientPressure({ request, response }: HttpContextContract) {
  ...
  public async storePatientGlycemia({ request, response }: HttpContextContract) {
  ...
  public async updateAnimalWeight({ params, request, response }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
      const payload = await request.validate(CreateAnimalWeightValidator);
  ...
  public async updateAnimalDocument({ params, request, response }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
      const payload = await request.validate(CreateAnimalDocumentValidator);
  ...
  public async storeAnimalPathology({ request, response }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
  ...
  public async updateAnimalPathology({ params, request, response }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
      const payload = await request.validate(CreateAnimalPathologyValidator);
  ...
  public async animalMedicalRecipeIndex({ params, response }: HttpContextContract) {
    return response.ok(await this.timelineService.medicalRecipeIndex(params.id));
  }

  public async storeAnimalMedicalRecipe({ request, response }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
  ...
  public async updateAnimalMedicalRecipe({ params, request, response }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
      const payload = await request.validate(CreateAnimalMedicalRecipeValidator);
  ...
  public async updateAnimalPhoto({ request, response, params }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
  ...
  public async addAnimalPhotoAttachments({ params, request, response }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
  ...
  public async deleteAnimalPhotoAttachments({ params, response }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
  ...
  public async updateAnimalVaccine({ params, request, response }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
      const { id } = params;
      const payload = await request.validate(UpsertAnimalVaccineValidator);
  ...
  public async deleteAnimalVaccine({ auth, params, response }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
  ...
  public async appointmentsIndex({ auth, params, response }: HttpContextContract) {
    return response.ok(
  ...
  public async appointmentsStore({ auth, request, response }: HttpContextContract) {
  ...
  public async hospitalizationIndex({ params, response }: HttpContextContract) {
    return response.ok(await this.timelineService.hospitalizationIndex(params.id));
  }
  ...
  public async updateObservations({ params, request, response }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
      const payload = await request.validate(CreateAnimalObservationValidator);
  ...
  public async deleteObservationMedia({ params, response }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
  ...
  public async storeDeath({ request, response, auth }: HttpContextContract) {
    return this.sharedService.errorHoc(response, async () => {
      ...
      await this.timelineService.storeDeath(await this.sharedService.getAuthContext(auth), payload);
      return response.created();
    });
  }
}
