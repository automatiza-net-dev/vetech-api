...
export default class Hospitalization extends BaseModel {
  ...
  public medicalPrescriptions: HasMany<typeof HospitalizationMedicalPrescription>;
  ...
  @hasMany(() => HospitalizationClinicParameter, {
    foreignKey: "hospitalization_id",
  })
  public parameters: HasMany<typeof HospitalizationClinicParameter>;
}
