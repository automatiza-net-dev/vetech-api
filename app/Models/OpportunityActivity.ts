...
export const OpportunityActivityStatus = ["Aberta", "Executada", "Cancelada", "Excluida"] as const;
export type TOpportunityActivityStatus = (typeof OpportunityActivityStatus)[number];
