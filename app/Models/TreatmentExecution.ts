...
const TreatmentExecutionStatus = ["Ativo", "Confirmado", "Cancelado", "Excluido"] as const;
...
export default class TreatmentExecution extends BaseModel {
  ...
  @belongsTo(() => ProductivityItem, {
    foreignKey: "productivity_item_id",
  })
  public productivityItem: BelongsTo<typeof ProductivityItem>;
