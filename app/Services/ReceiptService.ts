			...
			const newReceipt = await Receipt.create(
				{
					...
					receiptDate: DateTime.now(),
					// tag: GenerateTag(receiptsCounter.length + 1),
					productValue: bill.productValue?.toNumber() ?? 0,
					discountValue: bill.discountValue?.toNumber() ?? 0,
					deliveryValue: bill.deliveryValue?.toNumber() ?? 0,
					totalValue: bill.totalValue?.toNumber() ?? 0,
					icmsBase: bill.icmsBase?.toNumber() ?? 0,
					icmsValue: bill.icmsValue?.toNumber() ?? 0,
					icmsStBase: bill.icmsStBase?.toNumber() ?? 0,
					icmsStValue: bill.icmsStValue?.toNumber() ?? 0,
					pisBase: bill.pisBase?.toNumber() ?? 0,
					pisValue: bill.pisValue?.toNumber() ?? 0,
					cofinsBase: bill.cofinsBase?.toNumber() ?? 0,
					cofinsValue: bill.cofinsValue?.toNumber() ?? 0,
					ipiBase: bill.ipiBase?.toNumber() ?? 0,
					ipiValue: bill.ipiValue?.toNumber() ?? 0,
					icmsFcpValue: bill.icmsFcpValue?.toNumber() ?? 0,
					icmsUfDestinationValue: bill.icmsUfDestinationValue?.toNumber() ?? 0,
					otherValue: bill.otherValue?.toNumber() ?? 0,
