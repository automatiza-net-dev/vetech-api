...
export default class CreateBillPaymentValidator {
  ...
  public schema = schema.create({
    billId: schema.string.optional({ trim: true }, [
      rules.uuid(),
    ...
    clientCreditId: schema.number.optional([]),
    chunkOfBills: schema.array.optional().members(schema.string()),
    creditOverflow: schema.boolean.optional(),
  });
