...
export default class ConfirmBudgetValidator {
  ...
  reasonRules = [rules.uuid(), rules.exists({ table: "reasons", column: "id" })];
  ...
  public schema = schema.create({
    ...
    notConfirmedItems: schema
      .array()
      .members(
        schema.string({}, [rules.uuid(), rules.exists({ table: "budget_items", column: "id" })]),
      ),
    ...
    canceledObservation:
      this.type === "PARCIAL" ? schema.string({}, []) : schema.string.optional({}, []),
