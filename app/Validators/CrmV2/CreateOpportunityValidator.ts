...
export default class CreateOpportunityValidator {
  ...
  public schema = schema.create({
    ...
    kanbanId: schema.number([rules.exists({ table: "kanbans", column: "id" })]),
    statusId: schema.number([rules.exists({ table: "crm_statuses", column: "id" })]),
    contactDate: schema.date(),
    clientOriginItemDescription: schema.string.optional({}, []),

    raceId: schema.string.optional([rules.uuid(), rules.exists({ table: "races", column: "id" })]),
    ...
    contactTypeId: schema.number.optional([rules.exists({ table: "contact_types", column: "id" })]),
