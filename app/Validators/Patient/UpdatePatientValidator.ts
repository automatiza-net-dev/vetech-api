...
export default class UpdatePatientValidator {
  ...
  public schema = schema.create({
    ...
    raceId: schema.string({}, [rules.uuid(), rules.exists({ table: "races", column: "id" })]),
    vaccineOrigin: schema.enum.optional(Object.values(PatientVaccineOrigin), []),
    ...
    holders: schema.array().members(
      schema.object().members({
        id: schema.string({}, [rules.uuid(), rules.exists({ table: "patients", column: "id" })]),
        main: schema.boolean(),
      }),
    ),
  });
