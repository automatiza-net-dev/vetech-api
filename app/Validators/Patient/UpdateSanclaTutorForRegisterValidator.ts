...
export default class UpdateSanclaTutorForRegisterValidator {
  ...
  public schema = schema.create({
    ...
    clientOriginId: schema.string([rules.exists({ table: "client_origins", column: "id" })]),
    clientOriginItemDescription: schema.string.optional({}, []),
    professionId: schema.number([rules.exists({ table: "professions", column: "id" })]),
