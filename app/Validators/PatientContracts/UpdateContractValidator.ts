...
export default class UpdateContractValidator {
  ...
  public schema = schema.create({
    id: schema.number([rules.exists({ table: "patient_contracts", column: "id" })]),
    ...
    promotionalValueExpiration: schema.string({}, [rules.regex(/^\d{2}\/\d{4}$/)]),
