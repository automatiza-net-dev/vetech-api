...
export default class UpdatePatientExamValidator {
  ...
  public schema = schema.create({
    ...
    patientId: schema.string({}, [rules.exists({ table: "patients", column: "id" })]),
    scheduleId: schema.string.optional({}, [rules.exists({ table: "schedules", column: "id" })]),
    executionerId: schema.string.optional({}, [rules.exists({ table: "users", column: "id" })]),
