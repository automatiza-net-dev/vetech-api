...
export default class UpdatePatientVaccineValidator {
  constructor(protected ctx: HttpContextContract) {}

  public schema = schema.create({
    vaccineId: schema.string({}, [rules.uuid(), rules.exists({ table: "vaccines", column: "id" })]),
    vaccineProtocolId: schema.string({}, [
      rules.uuid(),
      rules.exists({ table: "vaccine_protocols", column: "id" }),
    ]),
    patientId: schema.string({}, [rules.uuid(), rules.exists({ table: "patients", column: "id" })]),
