...
export default class extends BaseSeeder {
  private BASE = [
    ...
    {
      code: 15,
      nomeBanco: "UBS Brasil Corretora de Câmbio, Títulos e Valores Mobiliários S.A.",
    },
    {
      code: 16,
      nomeBanco: "COOPERATIVA DE CRÉDITO MÚTUO DOS DESPACHANTES DE TRÂNSITO DE SANTA CATARINA E RI",
    },
    {
      code: 17,
    ...
    {
      code: 84,
      nomeBanco: "Uniprime Norte do Paraná – Coop de Economia e Crédito Mútuo dos Médicos",
    },
    {
      code: 85,
    ...
    {
      code: 91,
      nomeBanco: "CENTRAL DE COOPERATIVAS DE ECONOMIA E CRÉDITO MÚTUO DO ESTADO DO RIO GRANDE DO S",
    },
    {
      code: 92,
    ...
    {
      code: 93,
      nomeBanco: "PÓLOCRED SOCIEDADE DE CRÉDITO AO MICROEMPREENDEDOR E À EMPRESA DE PEQUENO PORT",
    },
    {
      code: 94,
    ...
    {
      code: 99,
      nomeBanco: "UNIPRIME CENTRAL – CENTRAL INTERESTADUAL DE COOPERATIVAS DE CREDITO LTDA.",
    },
    {
      code: 100,
    ...
    {
      code: 101,
      nomeBanco: "RENASCENCA DISTRIBUIDORA DE TÍTULOS E VALORES MOBILIÁRIOS LTDA",
    },
    {
      code: 102,
      nomeBanco: "XP INVESTIMENTOS CORRETORA DE CÂMBIO,TÍTULOS E VALORES MOBILIÁRIOS S/A",
    },
    {
      code: 104,
    ...
    {
      code: 111,
      nomeBanco: "OLIVEIRA TRUST DISTRIBUIDORA DE TÍTULOS E VALORES MOBILIARIOS S.A.",
    },
    {
      code: 113,
    ...
    {
      code: 114,
      nomeBanco: "Central Cooperativa de Crédito no Estado do Espírito Santo – CECOOP",
    },
    {
      code: 117,
    ...
    {
      code: 130,
      nomeBanco: "CARUANA S.A. – SOCIEDADE DE CRÉDITO, FINANCIAMENTO E INVESTIMENTO",
    },
    {
      code: 131,
    ...
    {
      code: 133,
      nomeBanco: "CONFEDERAÇÃO NACIONAL DAS COOPERATIVAS CENTRAIS DE CRÉDITO E ECONOMIA FAMILIAR E",
    },
    {
      code: 134,
      nomeBanco: "BGC LIQUIDEZ DISTRIBUIDORA DE TÍTULOS E VALORES MOBILIÁRIOS LTDA",
    },
    {
      code: 136,
      nomeBanco: "CONFEDERAÇÃO NACIONAL DAS COOPERATIVAS CENTRAIS UNICRED LTDA. – UNICRED DO BRASI",
    },
    {
      code: 138,
    ...
    {
      code: 157,
      nomeBanco: "ICAP do Brasil Corretora de Títulos e Valores Mobiliários Ltda.",
    },
    {
      code: 159,
      nomeBanco: "Casa do Crédito S.A. Sociedade de Crédito ao Microempreendedor",
    },
    {
      code: 163,
    ...
    {
      code: 173,
      nomeBanco: "BRL Trust Distribuidora de Títulos e Valores Mobiliários S.A.",
    },
    {
      code: 174,
      nomeBanco: "PERNAMBUCANAS FINANCIADORA S.A. – CRÉDITO, FINANCIAMENTO E INVESTIMENTO",
    },
    {
      code: 177,
    ...
    {
      code: 180,
      nomeBanco: "CM CAPITAL MARKETS CORRETORA DE CÂMBIO, TÍTULOS E VALORES MOBILIÁRIOS LTDA",
    },
    {
      code: 183,
      nomeBanco: "SOCRED S.A. – SOCIEDADE DE CRÉDITO AO MICROEMPREENDEDOR E À EMPRESA DE PEQUENO P",
    },
    {
      code: 184,
    ...
    {
      code: 188,
      nomeBanco: "ATIVA INVESTIMENTOS S.A. CORRETORA DE TÍTULOS, CÂMBIO E VALORES",
    },
    {
      code: 189,
    ...
    {
      code: 190,
      nomeBanco: "SERVICOOP – COOPERATIVA DE CRÉDITO DOS SERVIDORES PÚBLICOS ESTADUAIS DO RIO GRAN",
    },
    {
      code: 191,
    ...
    {
      code: 273,
      nomeBanco: "Cooperativa de Crédito Rural de São Miguel do Oeste – Sulcredi/São Miguel",
    },
    {
      code: 274,
      nomeBanco: "MONEY PLUS SOCIEDADE DE CRÉDITO AO MICROEMPREENDEDOR E A EMPRESA DE PEQUENO PORT",
    },
    {
      code: 276,
    ...
    {
      code: 283,
      nomeBanco: "RB CAPITAL INVESTIMENTOS DISTRIBUIDORA DE TÍTULOS E VALORES MOBILIÁRIOS LIMITADA",
    },
    {
      code: 285,
    ...
    {
      code: 293,
      nomeBanco: "Lastro RDV Distribuidora de Títulos e Valores Mobiliários Ltda.",
    },
    {
      code: 296,
    ...
    {
      code: 306,
      nomeBanco: "PORTOPAR DISTRIBUIDORA DE TITULOS E VALORES MOBILIARIOS LTDA.",
    },
    {
      code: 307,
      nomeBanco: "Terra Investimentos Distribuidora de Títulos e Valores Mobiliários Ltda.",
    },
    {
      code: 309,
    ...
    {
      code: 321,
      nomeBanco: "CREFAZ SOCIEDADE DE CRÉDITO AO MICROEMPREENDEDOR E A EMPRESA DE PEQUENO PORTE LT",
    },
    {
      code: 322,
      nomeBanco: "Cooperativa de Crédito Rural de Abelardo Luz – Sulcredi/Crediluz",
    },
    {
      code: 323,
    ...
    {
      code: 331,
      nomeBanco: "Fram Capital Distribuidora de Títulos e Valores Mobiliários S.A.",
    },
    {
      code: 332,
    ...
    {
      code: 343,
      nomeBanco: "FFA SOCIEDADE DE CRÉDITO AO MICROEMPREENDEDOR E À EMPRESA DE PEQUENO PORTE LTDA.",
    },
    {
      code: 348,
    ...
    {
      code: 354,
      nomeBanco: "NECTON INVESTIMENTOS S.A. CORRETORA DE VALORES MOBILIÁRIOS E COMMODITIES",
    },
    {
      code: 355,
