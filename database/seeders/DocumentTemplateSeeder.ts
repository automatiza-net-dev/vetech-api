...
export default class extends BaseSeeder {
  BASE = [
    ...
    {
      title: "3.1 - CONTRATO DE AUTORIZAÇÃO PARA SEDAÇÃO/ANESTESIA PARA EXAME/PROCEDIMENTO + LGPD",
    },
    {
    ...
    {
      title: "8 - TERMO DE NÃO AUTORIZAÇÃO DE EXAMES COMPLEMENTARES/PROCEDIMENTO",
    },
    {
      title:
    ...
    {
      title: "Declaração de comparecimento de tutor para atendimento veterinário",
    },
    {
    ...
    {
      title: "TERMO DE CONSENTIMENTO LIVRE E ESCLARECIDO PARA RELATO DE CASO - ESTUDO DE CASO",
    },
  ];
