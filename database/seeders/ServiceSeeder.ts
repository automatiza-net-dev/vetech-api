...
export const SERVICE_VARIATION_ID = "4b4addc3-db6a-4db8-a9fa-1cd4e0e47a03" as const;
export const SERVICE_VARIATION_OPTION_ID = "f03aa924-31a3-4954-a48a-bc58c9e332a9" as const;
export const SERVICE_VARIATION_GROUP_ID = "463898a0-96d0-4c9f-88de-54f30ee297e1" as const;
