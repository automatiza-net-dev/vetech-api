...
export default class extends BaseSeeder {
  private BASE: Array<Partial<TaxOperation>> = [
    ...
    {
      code: "5.102",
      description: "Venda de Mercadoria Adquirida ou Recebida de Terceiros Dentro do Estado",
    ...
    {
      code: "6.102",
      description: "Venda de Mercadoria Adquirida ou Recebida de Terceiros Fora do Estado",
      movementCategory: MovementCategory.NS,
      movementType: MovementType.S,
      generatesFinancial: true,
      accountingResult: true,
    ...
    {
      code: "6.152",
      description: "Transferencia de Mercadoria Adquirida ou Recebida de Terceiros Fora do Estado",
      movementCategory: MovementCategory.TS,
      movementType: MovementType.S,
      generatesFinancial: false,
      accountingResult: false,
