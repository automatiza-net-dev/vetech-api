...
test.group("Account plan group resource", (group) => {
  ...
  test("should create account plan group with dre group", async ({ assert, client }) => {
  ...
  test("should throw ResourceNotFoundException for account plan group", async ({
    ...
    const result = await client.get(`/account-plan-groups/-1`).bearerToken(token);
  ...
  test("should return account plan group", async ({ assert, client }) => {
    ...
    const result = await client.get(`/account-plan-groups/${apg.id}`).bearerToken(token);
  ...
  test("should update account plan group with dre group", async ({ assert, client }) => {
  ...
  test("should throw ResourceNotFoundException for invalid account plan group when deleting", async ({
    ...
    const result = await client.delete(`/account-plan-groups/-1`).bearerToken(token);
  ...
  test("should delete account plan group", async ({ assert, client }) => {
    ...
    const result = await client.delete(`/account-plan-groups/${apg.id}`).bearerToken(token);
