...
test.group("Bill resource", (group) => {
  ...
  const createData = async () => {
    ...
    const flagInstallment = await paymentMethodFlag.related("installments").create({
      installment: 1,
      fee: 10,
    });
  ...
  test("should search valid bills", async ({ assert, client }) => {
    ...
    const response = await client.get(`/bills?${qs.toString()}`).bearerToken(token);
  ...
  test("should create bill with financial responsible", async ({ assert, client }) => {
    const {
      user,
      client: holder,
      patient,
  ...
  test("should update bill", async ({ assert, client }) => {
    const { user, client: holder, patient, bill, business, variation, rule } = await createData();
    const token = await generateJwtToken(client, {
      email: user.email,
      password: "102030",
    });
  ...
  test("should create bill without open cashier", async ({ assert, client }) => {
  ...
  test("should create bill without cashier related", async ({ assert, client }) => {
    const { user, client: holder, patient } = await createData();
    const token = await generateJwtToken(client, {
      email: user.email,
      password: "102030",
  ...
  test("should create bill item (no daily cashier)", async ({ assert, client }) => {
    const { user, bill, variation, business, dailyCashier } = await createData();
    const token = await generateJwtToken(client, {
      email: user.email,
      password: "102030",
    });
  ...
  test("should create bill payment", async ({ assert, client }) => {
    const { user, bill, paymentMethod, tefAcq, tefFlag, flagInstallment } = await createData();
    const token = await generateJwtToken(client, {
      email: user.email,
      password: "102030",
    });
  ...
  test("should create bill payment with budget payment id", async ({ assert, client }) => {
  ...
  test("should create bill payment (no flag installment)", async ({ assert, client }) => {
  ...
  test("should create bill payment (installments)", async ({ assert, client }) => {
    const { user, bill, paymentMethod } = await createData();
    const token = await generateJwtToken(client, {
      email: user.email,
      password: "102030",
  ...
  test("should create bill payment with PMFlagId and invalid installments without password", async ({
    ...
    await paymentMethodFlag.merge({ maxInstallments: 20, installmentsWithoutPassword: 1 }).save();
  ...
  test("should create bill payment without PMFlagId and invalid installments without password", async ({
    ...
    await paymentMethod.merge({ maxInstallments: 20, installmentsWithoutPassword: 1 }).save();
  ...
  test("should return NotFoundException when deleting invalid bill payment ", async ({
    ...
    const response = await client.delete(`/bills/delete-payment/${v4()}`).bearerToken(token);
  ...
  test("should return NotFoundException when deleting unauthorized bill payment ", async ({
    ...
    const response = await client.delete(`/bills/delete-payment/${payment.id}`).bearerToken(token);
  ...
  test("should return NotFoundException if no bill was found when closing", async ({
    ...
    const response = await client.put(`/bills/close-bill/${v4()}`).bearerToken(token);
  ...
  test("should return BadRequestException if bill is not open when closing", async ({
    ...
    const response = await client.put(`/bills/close-bill/${bill.id}`).bearerToken(token);
  ...
  test("should exclude bill", async ({ assert, client }) => {
    ...
    const response = await client.put(`/bills/exclude-bill/${bill.id}`).bearerToken(token);
  ...
  test("should return NotFoundException if no bill was found when reopening", async ({
    ...
    const response = await client.put(`/bills/reopen-bill/${v4()}`).bearerToken(token);
  ...
  test("should return BadRequestException if bill is not closed when reopening", async ({
    ...
    const response = await client.put(`/bills/reopen-bill/${bill.id}`).bearerToken(token);
  ...
  test("should disable bill item", async ({ assert, client }) => {
    ...
    const response = await client.put(`/bills/disable-item/${item.id}`).bearerToken(token);
  ...
  test("should delete bill item", async ({ assert, client }) => {
    ...
    const response = await client.put(`/bills/delete-item/${item.id}`).bearerToken(token);
  ...
  test("should throw BadRequestException if bill is not active", async ({ assert, client }) => {
    const { user, bill, kit } = await createData();
    const token = await generateJwtToken(client, {
      email: user.email,
      password: "102030",
  ...
  test("should throw BadRequestException if kit is not active", async ({ assert, client }) => {
    const { user, bill, kit } = await createData();
    const token = await generateJwtToken(client, {
      email: user.email,
      password: "102030",
  ...
  test("should fetch daily cashier conference data", async ({ assert, client }) => {
    ...
    const response = await client.get(`/bills/conference/${dailyCashier.id}`).bearerToken(token);

    assert.equal(200, response.status());
  });

  test("should update daily cashier conference data", async ({ assert, client }) => {
  ...
  test("should create treatment from bill for items with unitary type", async ({
    ...
    const { user, bill, variation, product, productivityItem } = await createData();
    const token = await generateJwtToken(client, {
      email: user.email,
      password: "102030",
    });
  ...
  test("should update bill financial responsible", async ({ assert, client }) => {
  ...
  test("should return 204 if no invalid item was found", async ({ assert, client }) => {
    const { user, group, business, variation, buProduct } = await createData();
    const token = await generateJwtToken(client, {
      email: user.email,
      password: "102030",
