...
test.group("Finance resource", (group) => {
  ...
  test("should throw BadRequestException if no cashier was found (type = usuario)", async ({
    ...
    const { user, accountPlan, tutor, paymentMethod, dailyCashier } = await createData();
  ...
  test("should throw BadRequestException if no cashier was found (type = geral)", async ({
    ...
    const { user, accountPlan, tutor, paymentMethod, dailyCashier, config } = await createData();
  ...
  test("should create finance (with tef related)", async ({ assert, client }) => {
    const { user, accountPlan, tutor, paymentMethod, tefAcq, tefFlag } = await createData();
    const token = await generateJwtToken(client, {
      email: user.email,
      password: "102030",
    });
  ...
  test("should search finance", async ({ assert, client }) => {
    ...
    const response = await client.get(`/finances?${qs.toString()}`).bearerToken(token);
  ...
  test("should get expiring expenses", async ({ assert, client }) => {
    ...
    const response = await client.get(`/finances/expiring-expenses`).bearerToken(token);
  ...
  test("should get expiring payments", async ({ assert, client }) => {
    ...
    const response = await client.get(`/finances/expiring-payments`).bearerToken(token);
  ...
  test("should get checking accounts resume", async ({ assert, client }) => {
    ...
    const response = await client.get(`/finances/checking-accounts-resume`).bearerToken(token);
  ...
  test("should get open cashiers resume", async ({ assert, client }) => {
    ...
    const response = await client.get(`/finances/open-cashiers-resume`).bearerToken(token);
  ...
  test("should get closed cashiers resume", async ({ assert, client }) => {
    ...
    const response = await client.get(`/finances/closed-cashiers-resume`).bearerToken(token);
  ...
  test("should get revised cashiers resume", async ({ assert, client }) => {
    ...
    const response = await client.get(`/finances/revised-cashiers-resume`).bearerToken(token);
  ...
  test("should store bordero", async ({ assert, client }) => {
    const { user } = await createData();
  ...
  test("should store bordero items for existing bordero", async ({ assert, client }) => {
    const { user, finance } = await createData();
  ...
  test("should throw BadRequestException when downing invalid bordero", async ({
    ...
    const { user, finance, paymentMethod, checkingAccount } = await createData();
